...
public class Edges implements org.apache.thrift.TBase<Edges, Edges._Fields>, java.io.Serializable, Cloneable {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case V1ID:
      return Long.valueOf(getV1id());

    case V2ID:
      return Long.valueOf(getV2id());
  ...
  public int compareTo(Edges other) {
    ...
    Edges typedOther = (Edges)other;

    lastComparison = Boolean.valueOf(isSetV1id()).compareTo(typedOther.isSetV1id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV1id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.V1id, typedOther.V1id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetV2id()).compareTo(typedOther.isSetV2id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetV2id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.V2id, typedOther.V2id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
